    ...
    return (
        <div className="scheme">
            ...
            <div className="scheme__blocks">
                ...
                <img alt=""></img>
                <SchemeBlock line = {line_2} cube = {cube_2} title = "Efficiency" main_txt = "Predictive Audiences that ensure you invest the optimal amount based on every customer’s predicted conversion and customer lifetime value. No waste."/>
                <img alt=""></img>
